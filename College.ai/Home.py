...
st.set_page_config(page_title="CarrerCraft.ai", page_icon='src/Logo College.png', layout='wide', initial_sidebar_state="expanded")
...
# Home Page Function
def home():
    st.markdown("<h1 style='text-align: center;'>Welcome to CareerCraft.ai!</h1>", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: center;'>AI-powered System for Job Seekers</h4>", unsafe_allow_html=True)
...
def main():
    ...
    with st.sidebar:
        ...
        tabs = on_hover_tabs(
            tabName=['Home', 'Ask To PDF', 'Resume Analyser', 'Contest Calendar', 'Prompt Examples', 'About'], 
    ...
    st.markdown("<p style='text-align: center; color: #D3D3D3;'>- ©️Team Unstoppable -</p>", unsafe_allow_html=True)
